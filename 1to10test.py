...
def loading():
    ...
    with detection_graph.as_default():
        ...
        PATH_TO_CKPT = '/home/yanjieliu/models/models/research/object_detection/pretrained_models/mask_rcnn_inception_resnet_v2_atrous_coco_2018_01_28' + '/frozen_inference_graph.pb'
...
def Detection(image_path="/home/yanjieliu/dataset/img_test/p3.jpg"):
    loading()
    #start = time.time()
    with detection_graph.as_default():
